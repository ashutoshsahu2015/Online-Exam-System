...
import javax.swing.*;
public  class PPL2 extends Frame implements ActionListener , ItemListener
{
    Button b1,b2;
    Label l1;
    TextField t1;
    ...
    PPL2(int a)
    {
         ...
         b1=new Button("Exit");
         t1=new  TextField(20);
         l1=new Label("2)Varification is focused on? ");
        cbg=new CheckboxGroup();
        cb1=new Checkbox("a)Product",cbg,false);
        cb2=new Checkbox("b)Process",cbg,false);    
        cb3=new Checkbox("c)Both",cbg,false);
        cb4=new Checkbox("d)None",cbg,false);//b)
