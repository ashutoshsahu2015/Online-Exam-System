...
import javax.swing.*;
public  class ADS5 extends Frame implements ActionListener , ItemListener
{
    Button b1,b2;
    Label l1;
    TextField t1;
    ...
    ADS5(int n)
    {
         ...
         b1=new Button("Exit");
         t1=new  TextField(20);
         l1=new Label("5)Given a hash table T with 25 slots that stores 2000 elements, the load factor a(alpha) for T is __________?");
        cbg=new CheckboxGroup();
        cb1=new Checkbox("a)0.0125 ",cbg,false);
        cb2=new Checkbox("b)80 ",cbg,false);    
        cb3=new Checkbox("c)8000",cbg,false);
        cb4=new Checkbox("d)1.25 ",cbg,false); 
